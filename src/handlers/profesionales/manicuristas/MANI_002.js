...
const ID     = 'MANI_002';
const NOMBRE = 'Sofia Prueba';
const PHONE  = process.env.PROF_PHONE_MANI_002 || '';
const LID    = process.env.PROF_LID_MANI_002 || '';
const profState = {};
